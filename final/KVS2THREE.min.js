...
KVS.THREEScreen.prototype = {
  ...
  init: function(a, c) {
    ...
    void 0 === c.targetDom && (c.targetDom = document.getElementById('canvas'));
    this.width = c.width;
...
KVS.ToTHREEMesh = function(a) {
  ...
  if (0 == a.colors.length) f.color = new THREE.Color("white");
    ...
    for (f.vertexColors = THREE.VertexColors, b = 0; b < d; b++) {
      ...
      for (f.vertexColors = THREE.FaceColors, b = 0; b < d; b++) e = a.colors[b], c.faces[b].color = new THREE.Color(e[0], e[1], e[2]);
...
KVS.ToTHREEParticleSystem = function(a) {
  THREE.ShaderLib.particle_basic.fragmentShader = ["uniform vec3 psColor;\nuniform float opacity;", THREE.ShaderChunk.color_pars_fragment, THREE.ShaderChunk.map_particle_pars_fragment, THREE.ShaderChunk.fog_pars_fragment, THREE.ShaderChunk.shadowmap_pars_fragment, THREE.ShaderChunk.logdepthbuf_pars_fragment, "void main() {\nvec3 n;\nn.xy = gl_PointCoord * 2.0 - 1.0;\nn.z = 1.0 - dot( n.xy, n.xy );\nif ( n.z < 0.0 ) discard;\n    gl_FragColor = vec4( psColor, opacity );",
    THREE.ShaderChunk.logdepthbuf_fragment, THREE.ShaderChunk.map_particle_fragment, THREE.ShaderChunk.alphatest_fragment, THREE.ShaderChunk.color_fragment, THREE.ShaderChunk.shadowmap_fragment, THREE.ShaderChunk.fog_fragment, "}"
  ].join("\n");
  var c = new THREE.Geometry,
  ...
  if (0 == a.colors.length) f.color = new THREE.Color("white");
    ...
    f.vertexColors = !0;
    for (var b = 0; b < a.colors.length; b++) d =
